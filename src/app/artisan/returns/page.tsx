...
const returns: ReturnItem[] = [
  ...
  },
  {
    ...
    name: 'Teak Table',
    status: 'awaiting',
    detail: 'Lease period ended',
    user: '@marco_buy',
    imageBg: 'from-[#C8A882] to-[#9C7A5A]',
  },
  {
    id: '3',
    name: 'Plastic Accent Chair',
    status: 'refurbishing',
    detail: 'Restoring surface finish',
    user: '@eco_home',
    imageBg: 'from-[#A0B4C8] to-[#6080A0]',
  },
]
...
export default function ArtisanReturnsPage() {
            ...
            return (
              ...
              >
                ...
                <div className="space-y-4 p-4 pl-5">
                  ...
                  {/* Title + detail */}
                  <div>
                    <h2 className="text-charcoal text-base font-bold">{item.name}</h2>
                  ...
                  <div className="border-border flex items-center justify-between border-t pt-3">
                    <span className="text-stone text-xs">User: {item.user}</span>
                    {item.status === 'in_use' && (
