...
export default async function BuyerHomePage() {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,_#faf6f0_0%,_#fff9f4_40%,_#f5eee6_100%)] px-5 pt-7 pb-32">
      <div className="mx-auto max-w-md">
        ...
        <Link
          ...
          className="mt-7 flex items-center justify-between rounded-[32px] bg-[linear-gradient(135deg,_#1b5e3f_0%,_#0f3e2a_100%)] px-6 py-6 text-cream shadow-[0_24px_60px_rgba(27,94,63,0.24)]"
        >
          <div>
        ...
        <div className="mt-8 space-y-4">
          {recommendations.slice(0, 3).map((recommendation) => (
            <Link
              ...
              className="block overflow-hidden rounded-[30px] border border-stone-200 bg-white shadow-[0_18px_44px_rgba(44,44,44,0.08)]"
            >
              <div
